        ...
        <div className="w-full">
          <div className="mb-7">
            ...
            <p className="mt-2 text-sm text-gray-400 leading-relaxed">
              Continue with Google or use your email below. We&apos;ll set up
              your Cleared Mission Profile after sign-up.
            </p>
          </div>
          <SignUp appearance={clerkAppearance} signInUrl="/auth/signin" />
        </div>
      }
    />
  );
